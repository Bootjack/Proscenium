...
define([], function () {
    ...
    Curtain = function (config) {
         ...
         * the first thing a player encounters is gameplay selection interface.
         ...
         * of the stage during gameplay. The interface is the medium through which
         * the player interacts with the scenes onstage. It captures player input
         * like keyboard or mouse controls and provides meta-information about the
         * scene and objects.
         * 
         * This is where non-visual gameplay becomes a viable option. In such a game,
         ...
         * also include a physics engine to handle the friction of cards sliding
